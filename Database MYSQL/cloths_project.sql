...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 13, 2023 at 08:48 PM
...
INSERT INTO `employee` (`u_id`, `u_name`, `u_email`, `u_pass`, `u_image`, `role`) VALUES
...
(49, 'BLACK SHERWANI', '28,500.00', 'Size	Make To Order Color	Black', 'men shenwari image 01.webp', 2),
...
--
ALTER TABLE `products`
  MODIFY `p_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
