    ...
    <div class="container" style="margin-top: 25px;">
          ...
          <div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
            <div class="filter-col1 p-r-15 p-b-27">
              ...
              <ul>
                ...
                <li class="p-b-6">
                  <a href="men.php?sort=low_to_high" class="filter-link stext-106 trans-04">
                    Price: Low to High
                  </a>
                </li>
                <li class="p-b-6">
                  <a href="men.php?sort=high_to_low" class="filter-link stext-106 trans-04">
                    Price: High to Low
                  </a>
                </li>
                <li class="p-b-6">
                  <a href="men.php?sort=all" class="filter-link stext-106 trans-04">
                    Show All
                  </a>
                </li>
      ...
      <form action="add_to_cart_code.php" method="post">
        ...
        <div class="row isotope-grid justify-content-between">
          ...
          $query = "SELECT * FROM shop_product WHERE sp_category = 2";
