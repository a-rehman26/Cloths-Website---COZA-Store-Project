...
<head>
    <title>Fragrance's Products</title>
    <meta charset="UTF-8" />
        ...
        <div class="container" style="margin-top: 25px;">
          ...
          <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".Accessories">
                ...
                <li class="p-b-6">
                  <a href="#" class="filter-link stext-106 trans-04 filter-link-active">
                    Newness
                                ...
                                <li class="p-b-6">
                                    <a href="perfume.php?sort=low_to_high" class="filter-link stext-106 trans-04">
                                        Price: Low to High
                                    </a>
                                </li>
                                <li class="p-b-6">
                                    <a href="perfume.php?sort=high_to_low" class="filter-link stext-106 trans-04">
                                        Price: High to Low
                                    </a>
                                </li>
                                <li class="p-b-6">
                                    <a href="perfume.php?sort=all" class="filter-link stext-106 trans-04">
                                        Show All
                                    </a>
                                </li>
            ...
            <div class="row isotope-grid justify-content-between">
                ...
                $query = "SELECT * FROM shop_product WHERE sp_category = 5";
